...
Do not rely on the hosted app alone if your organization requires a controlled deployment, custom auth, or specific data residency rules. Review [Self-hosting](/self-hosting/docker) instead. If an application requires a file upload, export a PDF rather than sending only a public URL.
...
<CardGroup cols={2}>
  ...
  <Card title="Source code" icon="github" href="https://github.com/mnzn12138/reactive-resume">
