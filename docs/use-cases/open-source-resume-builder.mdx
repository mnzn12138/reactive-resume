...
The project repository is on [GitHub](https://github.com/mnzn12138/reactive-resume). You can read the code, report issues, contribute improvements, and see how the builder, the API, the self-hosting setup, and the documentation are put together.
...
To contribute, set up the project with [Development setup](/contributing/development). To run it yourself, start with [Self-hosting](/self-hosting/docker).
