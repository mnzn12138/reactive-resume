...
<CardGroup cols={2}>
  ...
  <Card title="New v5 Instance">
    A fresh Reactive Resume v5 instance set up and running. Follow the [Self-hosting](/self-hosting/docker)
  ...
  <Card title="Backup">A recent backup of your v4 database. Always back up before any migration.</Card>
</CardGroup>
