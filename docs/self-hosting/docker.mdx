...
- Docker Hub: `mnzn12138/reactive-resume:latest`
- GitHub Container Registry: `ghcr.io/mnzn12138/reactive-resume:latest`
...
services:
  ...
  reactive-resume:
    image: mnzn12138/reactive-resume:latest
    # image: ghcr.io/mnzn12138/reactive-resume:latest
    restart: unless-stopped
    ports:
      - "3000:3000"
    env_file:
...
```
    ...
    <Tip>
      Prefer pulling from Docker Hub? Keep <code>mnzn12138/reactive-resume:latest</code>. Prefer GHCR? Swap it to <code>ghcr.io/mnzn12138/reactive-resume:latest</code>.
    </Tip>
...
- Use the official `mnzn12138/reactive-resume:latest` or `ghcr.io/mnzn12138/reactive-resume:latest` image for the
  app container.
